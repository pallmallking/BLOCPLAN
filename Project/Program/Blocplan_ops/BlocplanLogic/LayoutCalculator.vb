Public Class LayoutCalculator
    ...
    Public Function CalculateLayout(
        ...
        ' Cache the sum to avoid repeated calculations
        ...
        ' Consolidate width normalization
        ...
        ' Consolidate length/width calculations in single loop
        index = 0
        ...
        ' Pre-allocate lists with capacity for better performance
        ...
        ' Sort both lists once and calculate bounds efficiently
        distList.Sort()
        relList.Sort()
        
        ' Calculate lower bound (smallest distances with highest scores)
        lBound = 0
        For i = 0 To relList.Count - 1
            lBound += relList(relList.Count - 1 - i) * distList(i)
        Next

        ' Calculate upper bound (largest distances with highest scores)
        uBound = 0
        For i = 0 To relList.Count - 1
